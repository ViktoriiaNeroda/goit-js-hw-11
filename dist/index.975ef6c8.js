...
var _callback = require("./js/callback");
var _refs = require("./js/refs");
const refs = (0, _refs.getRefs)();
refs.loadMoreBtnSubmit.hidden = true;
refs.searchFormBtnSubmit.disabled = true;
refs.galleryWrapper.innerHTML = "";
refs.formInputRef.addEventListener("input", (0, _callback.hendleOnSearchFormInput));
refs.searchFormEl.addEventListener("submit", (0, _callback.hendleSearchFormBtnSubmitClick));
refs.loadMoreBtnSubmit.addEventListener("click", (0, _callback.hendleLoadMoreBtnClick));
(0, _callback.btnUp).addEventListener();

},{"./js/callback":"i44zl","./js/refs":"2WoF2"}],"i44zl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hendleOnSearchFormInput", ()=>hendleOnSearchFormInput);
parcelHelpers.export(exports, "hendleSearchFormBtnSubmitClick", ()=>hendleSearchFormBtnSubmitClick);
parcelHelpers.export(exports, "hendleLoadMoreBtnClick", ()=>hendleLoadMoreBtnClick);
parcelHelpers.export(exports, "smoothScrollGalleryList", ()=>smoothScrollGalleryList);
parcelHelpers.export(exports, "btnUp", ()=>btnUp);
var _getApi = require("./get-api");
var _renderItem = require("./render-item");
...
const hendleOnSearchFormInput = async (event)=>{
    if (!event.target.value.trim()) return await (refs.searchFormBtnSubmit.disabled = true);
    else if (event.target.value.trim().length > 0) return await (refs.searchFormBtnSubmit.disabled = false);
};
const hendleSearchFormBtnSubmitClick = async (event)=>{
    event.preventDefault();
    refs.galleryWrapper.innerHTML = "";
    inputedData = refs.formInputRef.value.trim();
    const response = await (0, _getApi.getAsked)(inputedData);
    try {
        ...
        if (totalHits === 0) {
            ...
            refs.loadMoreBtnSubmit.hidden = true;
            (0, _notiflixNotifyAio.Notify).success(`We found  ${totalHits} images.`);
            refs.galleryWrapper.insertAdjacentHTML("beforeend", (0, _renderItem.createMarkup)(hits));
            return (0, _notiflixNotifyAio.Notify).failure(`We're sorry, but you've reached the end of search results.`);
        }
        refs.galleryWrapper.insertAdjacentHTML("beforeend", (0, _renderItem.createMarkup)(hits));
        lightbox.refresh();
        return (0, _notiflixNotifyAio.Notify).success(`We found  ${totalHits} images.`);
    } catch (error) {
        return (0, _notiflixNotifyAio.Notify).failure(`Oops! The operation cannot be completed, Error is ${error.message}`);
    }
};
const hendleLoadMoreBtnClick = async ()=>{
    pageNumber += 1;
    try {
        const response = await (0, _getApi.getAsked)(inputedData, pageNumber, perPage);
...
},{"./get-api":"4hf54","./render-item":"cc9XC","./refs":"2WoF2","notiflix/build/notiflix-notify-aio":"eXQLZ","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4hf54":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAsked", ()=>getAsked);
var _notiflixNotifyAio = require("notiflix/build/notiflix-notify-aio");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const BASE_URL = "https://pixabay.com/api/";
const API_KEY = "38392078-db89c19ac20a7bd4eddb18d45";
async function getAsked(inputedData, pageNumber, perPage) {
    ...
    try {
        return await (0, _axiosDefault.default).get(`${BASE_URL}?${options}`);
    } catch (error) {
        (0, _notiflixNotifyAio.Notify).info("Sorry.", "There are no images matching your search query. Please try again.", "Okay");
    }
}

},{"notiflix/build/notiflix-notify-aio":"eXQLZ","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cc9XC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
